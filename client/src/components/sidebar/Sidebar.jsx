  ...
  return (
    <div className="sidebar">
      <div className="sidebarItem">
        ...
        <img
          src="https://cdn.pixabay.com/photo/2018/09/21/08/54/book-3692572_1280.jpg"
          alt=""
        />
        <p>
          ...
          and ruining people, sex and frustration. Love is what people believe
          is worth the path of devastation.
        </p>
      </div>
      <div className="sidebarItem">
